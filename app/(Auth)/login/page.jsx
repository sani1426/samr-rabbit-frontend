...
const page = () => {
  ...
  return (
    ...
    <div className="mb-4">
      ...
      <input type="password" className="w-full p-2 border rounded" onChange={(e)=> setPassword(e.target.value)} value={password} placeholder="رمز عبور خود را وارد کنید" />
    </div>
    <button type="submit" className="w-full bg-black text-white p-2 rounded-lg font-semibold  hover:bg-gray-800 transition">ورود</button>
    <p className="mt-6 text-center text-sm">ثبت نام نکرده اید؟ <Link href="/register" className="text-blue-600" >ثبت نام</Link></p>
        </form>
      </div>
