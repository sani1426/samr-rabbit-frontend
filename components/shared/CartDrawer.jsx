...
const CartDrawer = () => {
  ...
  return (
    ...
    <div className={`fixed top-0 left-0 w-3/4 sm:w-1/2 md:w-1/3 h-full bg-white shadow-lg transform transition-transform duration-300 z-50 ${sideBarOpen ? "translate-x-0" : "translate-x-full"}`}>
      <div className="flex justify-end p-4">
