    ...
    <section className="py-16 px-4 lg:px-0">
        <div className="container mx-auto flex flex-col md:flex-row gap-8">
            <div className="relative flex-1">
                <Image src={menCollectionImg} alt="men-collection" className="w-full h-150 object-cover" />
            ...
            <div className="relative flex-1">
                <Image src={womenCollectionImg} alt="women-collection" className="w-full h-150 object-cover" />
                <div className="absolute bottom-8 right-8 bg-white/80 p-4">
